        ...
        /*public string SubmitOrder()
        {
            try
            {
                ...
                if (existingCustomer == null)
                {
                    ...
                    CurrentCustomer.PurchaseCount += 1;
                }
                else
                {
                ...
                Order newOrder = new Order
                {
                    ...
                    CoffeeRedeemed = false // Initialize CoffeeRedeemed to false
                };

                // Check if the purchase count is a multiple of 3 (3rd, 6th, 9th, and so on)
                if (existingCustomer.IsMember && existingCustomer.PurchaseCount % 3 == 0)
                {
                    // Apply a 100% discount on the coffee price for every 3rd purchase
                    discountedPrice -= SelectedCoffee.CoffeePrice;

                    // Set CoffeeRedeemed property in the new order
                    newOrder.CoffeeRedeemed = true;
                }
                ...
                *//*return newOrder.CoffeeRedeemed ? "Coffee Redeemed! Order submitted successfully!" : "Order submitted successfully!";*//*
                return "Reedemed";
            }
            catch (Exception ex)
            {
                ...
                return "Error submitting the order. Please try again.";
            }
        }
...
*/
        ...
        {            
            ...
            try
            {
                ...
                {
                    // Check if the purchase count is a multiple of 3 (3rd, 6th, 9th, and so on)
                    if (existingCustomer.PurchaseCount % 2 == 0)
                    {
                        // Apply a 100% discount on the coffee price for every 3rd purchase
                        discountedPrice = 0;
                    }
                    ...
                    {
                        // Apply a 10% discount to the total price for the member (excluding the 100% discount case)
                        discountedPrice *= 0.9m;
                    }
                }
                ...
                Order newOrder = new Order
                {
                    ...
                    SelectedAddIns = SelectedAddIn != null ? new List<AddIns>(SelectedAddIn) : new List<AddIns>(),
                    TotalPrice = discountedPrice,
                    CoffeeRedeemed = existingCustomer.IsMember && existingCustomer.PurchaseCount % 2 == 0 // Set CoffeeRedeemed based on the condition
                };
